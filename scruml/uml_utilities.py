...
def parse_relationship_identifier(ident: str) -> Optional[Tuple[str, str]]:
...
separated by a comma."""
    ...
    # Make sure that the correct number of values was provided
    if len(ident_list) != 2:
        return None
    ...
    return (str(class_A_name), str(class_B_name))
...
def stringify_relationship_identifier(class_name_a: str, class_name_b: str) -> str:
    """Returns a stringified relationship identifier from the provided class names."""

    return "[{},{}]".format(class_name_a, class_name_b)
